...
namespace pwn {
class printline_node; 
class variable_decl_node; 
class print_node; 
class memory_alloc_node; 
class identity_node; 
class lvalue_node; 
class rvalue_node; 
...
#include "ast/printline_node.h"
#include "ast/variable_decl_node.h"
#include "ast/print_node.h"
#include "ast/memory_alloc_node.h"
...
#include "ast/def_function_node.h"
